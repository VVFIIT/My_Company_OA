...
public class AttendanceService extends BaseService implements InitializingBean {
	...
	public boolean isExistAttendanceMonth(AttendanceMonth attendanceMonth) {
		...
		for (AttendanceMonth existAttendanceMonth : existAttendanceMonthList) {
			if (attendanceMonth.getYear().equals(existAttendanceMonth.getYear())
					&& attendanceMonth.getMonth().equals(existAttendanceMonth.getMonth())) {
				isExistInDB = true;
				break;
			}
		}
	 ...
	 * @author Meng Lingshuai
	 */
	public AttendanceMonth changeValueToAtendanceStatus(AttendanceMonth attendanceMonth,
			List<AttendanceDay> attendanceStatus) {
	...
	public List<AttendanceMonth> getAttendanceShow(AttendanceMonth attendance) {
		...
		List<AttendanceMonth> attendanceList = attendanceMonthDao.getIdAttendance(attendanceInsert);
	...
	public Page<AttendanceMonth> getAttendanceShowAllDefault(Page<User> page, AttendanceMonth attendanceMonth) {
		...
		for (User userInformation : userList) {
			...
			List<AttendanceMonth> attendanceList = attendanceMonthDao.getAttendance(attendanceInsert);
